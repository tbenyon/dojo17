...
if( !class_exists('Benyon_acf_field_user_select') ) :


class Benyon_acf_field_user_select extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('User Select', 'TEXTDOMAIN');
		...
		*  var message = acf._e('user_select', 'error');
		*/
...
// initialize
new Benyon_acf_field_user_select( $this->settings );
